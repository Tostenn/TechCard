class TechCard {
    ...
    constructor(option = {}) {
        ...
        this.option = {
            ...
            cssHref: "https://cdn.jsdelivr.net/gh/Tostenn/TechCard/build/techcard.css",
            user: {
                name: "",
                role: "",
                bio: "",
    ...
    makeCardSoloMini(root = document) {
        ...
        const content = this.makeElement(header, "div", "flex flex-col min-w-0 flex-1 justify-center");
