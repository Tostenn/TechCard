...
export class CardSoloMini extends BaseCard {
    render(root: ShadowRoot | HTMLElement): HTMLElement {
        ...
        const section = createElement("section", "signature-card signature-card--mini relative", {}, root);
        ...
        if (user.qrcode) {
            ...
            createElement("img", "h-full w-full object-cover", { 
                src: user.qrcode, 
                alt: "QR Code",
                loading: "lazy" 
            }, qrcode);
        ...
        const avatarWrap = createElement("div", "avatar-wrap avatar-wrap--mini", {}, header);
        ...
        const content = createElement("div", "flex flex-col min-w-0 flex-1 justify-center", {}, header);
